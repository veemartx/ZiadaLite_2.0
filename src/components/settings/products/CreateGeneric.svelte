<script>
    ...
    let createGenericBtnLoading = false;
    ...
    const handleCreateGeneric = async () => {
        ...
        try {
            const response = await axios({
                method: "POST",
                data: dt,
                url: `${apiBaseUrl}createGeneric.php`,
                headers: {
    ...
    <div class="wrapper">
        <div class="modal">
            <div class="modalContent segment">
                <div class="titleBar">
                    <div class="title">Create Generic</div>
                    <div class="action">
                    ...
                    <div class="createAllowedUploadForm">
                        ...
                        >
                            <div class="fieldInput">
                                <div class="field">
                                    <label for="type">Active Ingredient</label>
                                    <input
                                        type="text"
                                        name="type"
                                        id="name"
