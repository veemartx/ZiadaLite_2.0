<script>
    ...
    let createmanufacturerBtnLoading = false;
    ...
    const handleCreateManufacturer = async () => {
        ...
        try {
            const response = await axios({
                method: "POST",
                data: dt,
                url: `${apiBaseUrl}createNsManufacturer.php`,
                headers: {
    ...
    <div class="wrapper">
        <div class="modal">
            <div class="modalContent segment">
                <div class="titleBar">
                    <div class="title">Create Ns Manufacturer</div>
                    <div class="action">
                    ...
                    <div class="createAllowedUploadForm">
                        ...
                        >
                            <div class="fieldInput">
                                <div class="field">
                                    <label for="type">manufacturer Name</label>
                                    <input
                                        type="text"
                                        name="type"
                                        id="name"
